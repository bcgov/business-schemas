...
export type TheTypeOfThisTodoItem = "annualReport";
export type TheStatusOfThisTodoItem = string;

export interface RegistryTodoItem {
  todo: TheBusinessesSchema & {
    header: {
      name: TheTypeOfThisTodoItem;
      ARFilingYear?: number;
      status?: TheStatusOfThisTodoItem;
      [k: string]: unknown;
    };
    [k: string]: unknown;
  };
